...
public class FrmEditarProdutos extends javax.swing.JFrame {
    ...
    /**
     * DAO responsável pelas operações de produtos no banco de dados.
     */
    private ProdutoDAO produtoDAO = new ProdutoDAO();

    /**
     * DAO responsável pelas operações de categoria no banco de dados.
     */
    private CategoriaDAO categoriaDAO = new CategoriaDAO();

    /**
     * Construtor da janela FrmEditarProdutos.
     * <p>Inicializa componentes da interface, carrega a tabela de produtos
     * e popula o combo box de categorias.</p>
     */
    ...
    /**
     * Carrega as categorias disponíveis do banco de dados e adiciona
     * ao {@code JComboBox} de seleção de categorias.
     *
     * <p>Recupera a lista de {@link Categoria} via {@link CategoriaDAO#listar()},
     * limpa o modelo atual do combo e, para cada categoria, insere uma string
     * representativa (obtida por {@code toString()}).</p>
     */
    ...
    /**
     * Carrega todos os produtos cadastrados no banco de dados e popula
     * a tabela de exibição ({@code TableProdutos}).
     *
     * <p>Recupera a lista de {@link Produto} via {@link ProdutoDAO#listar()},
     * limpa todas as linhas atuais do {@code DefaultTableModel} associado
     * e adiciona, para cada produto, uma nova linha contendo:</p>
     * <ul>
     *   <li>ID do produto</li>
     *   <li>Nome</li>
     ...
     *   <li>Quantidade máxima</li>
     *   <li>Categoria (string retornada por {@code Produto#getCategoria().toString()})</li>
     * </ul>
     *
     * @since 1.0
     */
